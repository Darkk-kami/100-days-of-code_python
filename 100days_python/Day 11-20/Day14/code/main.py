...
while not end_game:
    ...
    A = print(f"Compare A: {option_a['name']} a {option_a['description']} from {option_a['country']}")
    print(vs)
    B = print(f"Against B: {option_b['name']} a {option_b['description']} from {option_b['country']}")
